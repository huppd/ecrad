...
#define exp_fast exp
  ...
  ! longwave
  subroutine calc_two_stream_gammas_lw(ng, istartcol, iendcol, mask, ssa, g, &
       &                               gamma1, gamma2)
...
!NEC$ shortloop
  ...
  subroutine calc_reflectance_transmittance_lw(ng, istartcol, iendcol, mask, &
       &    od, gamma1, gamma2, planck_bot, planck_top, &
