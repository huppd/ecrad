! radiation_lw_derivatives_acc.F90 - Compute longwave derivatives for Hogan and Bozzo (2015) method
!
...
module radiation_lw_derivatives_acc
...
contains
  ...
  subroutine calc_lw_derivatives_matrix(ng, nlev, nreg, icol, transmittance, &
    ...
    if (lhook) call dr_hook('radiation_lw_derivatives_acc:calc_lw_derivatives_matrix',0,hook_handle)
    ...
    if (lhook) call dr_hook('radiation_lw_derivatives_acc:calc_lw_derivatives_matrix',1,hook_handle)
  ...
  subroutine calc_lw_derivatives_region(ng, nlev, nreg, icol, transmittance, &
    ...
    if (lhook) call dr_hook('radiation_lw_derivatives_acc:calc_lw_derivatives_region',0,hook_handle)
    ...
    if (lhook) call dr_hook('radiation_lw_derivatives_acc:calc_lw_derivatives_region',1,hook_handle)

  end subroutine calc_lw_derivatives_region


end module radiation_lw_derivatives_acc
