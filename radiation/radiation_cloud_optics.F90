...
#include "radiation_delta_eddington.h"
  ...
  subroutine cloud_optics(nlev,istartcol,iendcol, &
    ...
    call cloud_optics_lw(nlev,istartcol,iendcol, config, thermodynamics, cloud, &
       &  od_lw_cloud, ssa_lw_cloud, g_lw_cloud)

    call cloud_optics_sw(nlev,istartcol,iendcol, config, thermodynamics, cloud, &
       &  od_sw_cloud, ssa_sw_cloud, g_sw_cloud)
  ...
  subroutine cloud_optics_lw(nlev,istartcol,iendcol, &
    ...
    use radiation_constants, only         : AccelDueToGravity
    use radiation_cloud_optics_data, only : cloud_optics_type
    use radiation_ice_optics_fu, only     : calc_ice_optics_fu_lw
    use radiation_ice_optics_baran, only  : calc_ice_optics_baran, &
         &                                  calc_ice_optics_baran2016
    use radiation_ice_optics_baran2017, only  : calc_ice_optics_baran2017
    use radiation_ice_optics_yi, only     : calc_ice_optics_yi_lw
    use radiation_liquid_optics_socrates, only:calc_liq_optics_socrates
    use radiation_liquid_optics_slingo, only:calc_liq_optics_slingo, &
         &                                   calc_liq_optics_lindner_li
    ...
    ! Longwave optical depth, scattering optical depth
    ...
    if (lhook) call dr_hook('radiation_cloud_optics:cloud_optics_lw',0,hook_handle)
    ...
    if (lhook) call dr_hook('radiation_cloud_optics:cloud_optics_lw',1,hook_handle)
  ...
  subroutine cloud_optics_sw(nlev,istartcol,iendcol, &
    ...
    ! Shortwave optical depth, scattering optical depth
    ! and asymmetry factor, for liquid and ice in all bands but a
    ! single cloud layer
    ...
    if (lhook) call dr_hook('radiation_cloud_optics:cloud_optics_sw',0,hook_handle)
    ...
    if (lhook) call dr_hook('radiation_cloud_optics:cloud_optics_sw',1,hook_handle)
